...
// console.log('myStatusCode>>>>>>>>>>',status)
setConfiguration('statusCode',status)
...
function getRequestHeaders(body, token) {
  ...
  // const acces_token = 'eyJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJsYXBhcmVkIiwiaWF0IjoxNTk5NDU5ODM5LCJqdGkiOiIzZjA0MGJmNi1kYWRhLTQ2NTItYTY2Yy0yZTA1N2VmMzExMzMiLCJ1c2VyIjp7ImlkIjoyOH19.e0dzgh8HOjU6LLUlnAKuxl85XxFop13w_Ow_bL0j3nxat_EGnpOfRKKywURcUkwZGiB-KEom2NviDBopD_oStA'
  // const acces_token = await AsyncStorage.getItem('token');
console.log('token>>>>>>>gggggg',acces_token)
  if (acces_token.length>0) {
      return {...headers, 'Authorization' : 'Bearer '+ acces_token,};
